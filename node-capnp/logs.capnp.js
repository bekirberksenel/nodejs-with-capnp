...
class Log extends capnp_ts_1.Struct {
    ...
    toString() { return "Log_" + super.toString(); }
}
Log._capnp = { displayName: "Log", id: "e78e304ba0b10abe", size: new capnp_ts_1.ObjectSize(16, 9) };
exports.Log = Log;
class Logs extends capnp_ts_1.Struct {
    adoptLogs(value) { capnp_ts_1.Struct.adopt(value, capnp_ts_1.Struct.getPointer(0, this)); }
    disownLogs() { return capnp_ts_1.Struct.disown(this.getLogs()); }
    getLogs() { return capnp_ts_1.Struct.getList(0, Logs._Logs, this); }
    hasLogs() { return !capnp_ts_1.Struct.isNull(capnp_ts_1.Struct.getPointer(0, this)); }
    initLogs(length) { return capnp_ts_1.Struct.initList(0, Logs._Logs, length, this); }
    setLogs(value) { capnp_ts_1.Struct.copyFrom(value, capnp_ts_1.Struct.getPointer(0, this)); }
    toString() { return "Logs_" + super.toString(); }
}
Logs._capnp = { displayName: "Logs", id: "dbd279c91bb6c1fe", size: new capnp_ts_1.ObjectSize(0, 1) };
exports.Logs = Logs;
Logs._Logs = capnp.CompositeList(Log);
