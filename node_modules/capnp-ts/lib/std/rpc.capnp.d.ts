...
export declare class Message extends __S {
    static readonly UNIMPLEMENTED: Message_Which;
    static readonly ABORT: Message_Which;
    static readonly BOOTSTRAP: Message_Which;
    static readonly CALL: Message_Which;
    static readonly RETURN: Message_Which;
    static readonly FINISH: Message_Which;
    static readonly RESOLVE: Message_Which;
    static readonly RELEASE: Message_Which;
    static readonly DISEMBARGO: Message_Which;
    static readonly OBSOLETE_SAVE: Message_Which;
    static readonly OBSOLETE_DELETE: Message_Which;
    static readonly PROVIDE: Message_Which;
    static readonly ACCEPT: Message_Which;
    static readonly JOIN: Message_Which;
...
export declare class Call_SendResultsTo extends __S {
    static readonly CALLER: Call_SendResultsTo_Which;
    static readonly YOURSELF: Call_SendResultsTo_Which;
    static readonly THIRD_PARTY: Call_SendResultsTo_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class Return extends __S {
    static readonly RESULTS: Return_Which;
    static readonly EXCEPTION: Return_Which;
    static readonly CANCELED: Return_Which;
    static readonly RESULTS_SENT_ELSEWHERE: Return_Which;
    static readonly TAKE_FROM_OTHER_QUESTION: Return_Which;
    static readonly ACCEPT_FROM_THIRD_PARTY: Return_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class Resolve extends __S {
    static readonly CAP: Resolve_Which;
    static readonly EXCEPTION: Resolve_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class Disembargo_Context extends __S {
    static readonly SENDER_LOOPBACK: Disembargo_Context_Which;
    static readonly RECEIVER_LOOPBACK: Disembargo_Context_Which;
    static readonly ACCEPT: Disembargo_Context_Which;
    static readonly PROVIDE: Disembargo_Context_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class MessageTarget extends __S {
    static readonly IMPORTED_CAP: MessageTarget_Which;
    static readonly PROMISED_ANSWER: MessageTarget_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class CapDescriptor extends __S {
    static readonly NONE: CapDescriptor_Which;
    static readonly SENDER_HOSTED: CapDescriptor_Which;
    static readonly SENDER_PROMISE: CapDescriptor_Which;
    static readonly RECEIVER_HOSTED: CapDescriptor_Which;
    static readonly RECEIVER_ANSWER: CapDescriptor_Which;
    static readonly THIRD_PARTY_HOSTED: CapDescriptor_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class PromisedAnswer_Op extends __S {
    static readonly NOOP: PromisedAnswer_Op_Which;
    static readonly GET_POINTER_FIELD: PromisedAnswer_Op_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
//# sourceMappingURL=rpc.capnp.d.ts.map