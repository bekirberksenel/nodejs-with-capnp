...
export declare class Node extends __S {
    static readonly FILE: Node_Which;
    static readonly STRUCT: Node_Which;
    static readonly ENUM: Node_Which;
    static readonly INTERFACE: Node_Which;
    static readonly CONST: Node_Which;
    static readonly ANNOTATION: Node_Which;
...
export declare class Field_Ordinal extends __S {
    static readonly IMPLICIT: Field_Ordinal_Which;
    static readonly EXPLICIT: Field_Ordinal_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class Field extends __S {
    static readonly NO_DISCRIMINANT: number;
    static readonly SLOT: Field_Which;
    static readonly GROUP: Field_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class Type_AnyPointer_Unconstrained extends __S {
    static readonly ANY_KIND: Type_AnyPointer_Unconstrained_Which;
    static readonly STRUCT: Type_AnyPointer_Unconstrained_Which;
    static readonly LIST: Type_AnyPointer_Unconstrained_Which;
    static readonly CAPABILITY: Type_AnyPointer_Unconstrained_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class Type_AnyPointer extends __S {
    static readonly UNCONSTRAINED: Type_AnyPointer_Which;
    static readonly PARAMETER: Type_AnyPointer_Which;
    static readonly IMPLICIT_METHOD_PARAMETER: Type_AnyPointer_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class Type extends __S {
    static readonly VOID: Type_Which;
    static readonly BOOL: Type_Which;
    static readonly INT8: Type_Which;
    static readonly INT16: Type_Which;
    static readonly INT32: Type_Which;
    static readonly INT64: Type_Which;
    static readonly UINT8: Type_Which;
    static readonly UINT16: Type_Which;
    static readonly UINT32: Type_Which;
    static readonly UINT64: Type_Which;
    static readonly FLOAT32: Type_Which;
    static readonly FLOAT64: Type_Which;
    static readonly TEXT: Type_Which;
    static readonly DATA: Type_Which;
    static readonly LIST: Type_Which;
    static readonly ENUM: Type_Which;
    static readonly STRUCT: Type_Which;
    static readonly INTERFACE: Type_Which;
    static readonly ANY_POINTER: Type_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class Brand_Scope extends __S {
    static readonly BIND: Brand_Scope_Which;
    static readonly INHERIT: Brand_Scope_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class Brand_Binding extends __S {
    static readonly UNBOUND: Brand_Binding_Which;
    static readonly TYPE: Brand_Binding_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
export declare class Value extends __S {
    static readonly VOID: Value_Which;
    static readonly BOOL: Value_Which;
    static readonly INT8: Value_Which;
    static readonly INT16: Value_Which;
    static readonly INT32: Value_Which;
    static readonly INT64: Value_Which;
    static readonly UINT8: Value_Which;
    static readonly UINT16: Value_Which;
    static readonly UINT32: Value_Which;
    static readonly UINT64: Value_Which;
    static readonly FLOAT32: Value_Which;
    static readonly FLOAT64: Value_Which;
    static readonly TEXT: Value_Which;
    static readonly DATA: Value_Which;
    static readonly LIST: Value_Which;
    static readonly ENUM: Value_Which;
    static readonly STRUCT: Value_Which;
    static readonly INTERFACE: Value_Which;
    static readonly ANY_POINTER: Value_Which;
    static readonly _capnp: {
        displayName: string;
        id: string;
        size: capnp.ObjectSize;
...
//# sourceMappingURL=schema.capnp.d.ts.map