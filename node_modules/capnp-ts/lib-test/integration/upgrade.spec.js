...
var upgrade_v1_capnp_1 = require("./upgrade-v1.capnp");
var upgrade_v2_capnp_1 = require("./upgrade-v2.capnp");
util_1.tap.test("schema upgrade with legacy data", function (t) {
    ...
    var u1 = m.initRoot(upgrade_v1_capnp_1.Upgrade);
    u1.setLegacyId(0x5555);
    u1.setLegacyName("hi");
    var v1Child = u1.initSelfReference();
    v1Child.setLegacyId(0x6666);
    v1Child.setLegacyName("hihi");
    var v1ListChild = u1.initSelfReferences(1).get(0);
    v1ListChild.setLegacyId(0x9999);
    v1ListChild.setLegacyName("hihihi");
    var u2 = m.getRoot(upgrade_v2_capnp_1.Upgrade);
    ...
    var v2Child = u2.getSelfReference();
    ...
    var v2ListChild = u2.getSelfReferences().get(0);
    t.doesNotThrow(function () {
...
//# sourceMappingURL=upgrade.spec.js.map
